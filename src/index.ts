...
import {
  LineType, PathType, PolygonType, TooltipShowRule, TooltipShowType, TooltipFeatureType, TooltipFeaturePosition,
...
export {
  ...
  utils,
  LineType, PathType, PolygonType, TooltipShowRule, TooltipShowType, TooltipFeatureType, TooltipFeaturePosition, CandleTooltipRectPosition,
